  ...
  return (
    <div className="w-full justify-center flex items-center my-5">
      ...
      {paginationRange.map(index => {
        ...
        return (
          <div
            className={classNames('text-white select-none cursor-pointer hover:bg-gray-300 w-7 h-7 flex items-center justify-center bg-gray-400 rounded-full mx-2', {
              'bg-gray-700' : currentPage === index
            })}
            key={index.toString()}
